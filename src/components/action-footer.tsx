...
export function ActionFooter({
  ...
  return (
    <ViewTransition>
      <footer className="fixed right-0 bottom-4 left-0 z-20 px-4 [view-transition-name:action-footer]">
        <div className="border-border/70 dark:bg-background/80 mx-auto max-w-4xl rounded-2xl border bg-white/90 p-4 shadow-xl shadow-black/10 backdrop-blur [view-transition-name:action-footer-bg]">
