...
const localDataPoints = [
  ...
  },
  {
    ...
    description:
      "Semantic-search chunks and the vectors generated on your device are stored on your device. If you opt into remote fallback, only the chunk text needed for that request is sent upstream for embedding and the resulting vector immediately returns to IndexedDB.",
  },
  {
    title: "Preferences and caches",
    description:
      "Theme selection, feature flags, and model caches are kept in your browser storage to preserve your experience offline.",
  },
] as const;
...
const aiDisclosures = [
  {
    ...
    description:
      "When you trigger an AI action (e.g., Ask Mnemos or Summarize), the specific text you submit is sent to the configured cloud model so it can respond.",
  },
  {
  ...
  },
  {
    ...
    description:
      "If your device cannot run the embedding model, the app pauses the action and asks whether you want to fall back to remote embedding generation before any text is transmitted.",
  },
  {
      ...
      <main className="mx-auto max-w-4xl space-y-12 px-6 py-16">
        <header className="space-y-4">
          ...
          <p className="text-muted-foreground text-base leading-relaxed">
            Mnemos is built as a privacy-first notebook designed to run on your
            device. This page explains what data is created, where it lives, and
            the limited cases where it can leave your browser.
          </p>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            cannot run embeddings on your device, Mnemos pauses the workflow and
            asks whether you want to enable remote embedding generation before
