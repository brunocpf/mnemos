...
class SummarizerWorkerService extends HfModelWorkerService<"text-generation"> {
  constructor() {
    const modelId =
...
export type SummarizerWorkerApi = SummarizerWorkerService;

expose(new SummarizerWorkerService());
